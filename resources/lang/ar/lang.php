...
return [
    ...
    'gateway_name_placeholder' => 'مثال: الكريمي جوال، وان كاش',
    'gateway_code' => 'كود البوابة',
    'gateway_code_placeholder' => 'مثال: kurimi, onecash',
    'gateway_code_helper' => 'معرف فريد يُستخدم في النظام (Slug)',
    'gateway_type' => 'نوع البوابة',
    'gateway_type_electronic' => 'دفع إلكتروني (API)',
    'gateway_type_cash' => 'دفع نقدي',
    'gateway_type_transfer' => 'حوالة بنكية',
    'gateway_type_helper' => 'حدد آلية عمل هذه البوابة',
    'gateway_mode' => 'وضع التشغيل',
    'gateway_mode_sandbox' => 'تجريبي (Sandbox)',
    'gateway_mode_live' => 'إنتاجي (Live)',
    'gateway_active_helper' => 'تفعيل أو تعطيل البوابة في المتجر',
    'gateway_basic_info_desc' => 'المعلومات الأساسية والإعدادات العامة لبوابة الدفع.',
    'gateway_credentials' => 'بيانات الاعتماد',
    'gateway_credentials_desc' => 'مفاتيح الربط والبيانات الأمنية (تظهر للبوابات الإلكترونية فقط).',
    'gateway_credential_key' => 'المفتاح',
    'gateway_credential_value' => 'القيمة',
    'add_credential' => 'إضافة بيان جديد',
    'gateway_instructions' => 'تعليمات الدفع',
    ...
    // Sales Reports API
    'sales_report_generated' => 'تم إنشاء تقرير المبيعات بنجاح',
    'vendor_sales_report_generated' => 'تم إنشاء تقرير مبيعات البائعين بنجاح',
    'vendor_sales_summary_generated' => 'تم إنشاء ملخص مبيعات البائع بنجاح',
    'sales_trends_generated' => 'تم إنشاء تقرير اتجاهات المبيعات بنجاح',
    'top_products_report_generated' => 'تم إنشاء تقرير أفضل المنتجات بنجاح',
    'period_comparison_generated' => 'تم إنشاء تقرير مقارنة الفترات بنجاح',
    'customer_metrics_generated' => 'تم إنشاء تقرير مؤشرات العملاء بنجاح',
    'dashboard_data_generated' => 'تم تحميل بيانات لوحة التحكم بنجاح',
    'invalid_group_by_parameter' => 'قيمة التجميع غير صالحة. استخدم: daily أو weekly أو monthly',
    ...
    'start_date_before_end_date' => 'تاريخ البداية يجب أن يكون قبل أو يساوي تاريخ النهاية',
    'end_date_after_start_date' => 'تاريخ النهاية يجب أن يكون بعد أو يساوي تاريخ البداية',
    'limit_must_be_positive' => 'الحد الأقصى يجب أن يكون 1 على الأقل',
    'limit_max_100' => 'الحد الأقصى لا يمكن أن يتجاوز 100',
    ...
    'cancelled_orders_count' => 'الطلبات الملغاة',
    'cancelled_amount' => 'قيمة الطلبات الملغاة',
    'cancellation_rate' => 'نسبة الإلغاء',
    'success_rate' => 'نسبة النجاح',
    'revenue_percentage' => 'نسبة الإيرادات',
    'revenue_change' => 'تغير الإيرادات',
    'orders_change' => 'تغير الطلبات',
    'average_change' => 'تغير المتوسط',
    'new_customers_count' => 'العملاء الجدد',
    'returning_customers' => 'العملاء المتكررين',
    'new_customer_revenue' => 'إيرادات العملاء الجدد',
    'returning_customer_revenue' => 'إيرادات العملاء المتكررين',
    ...
    // Vendors Reports API - تقرير أداء الموردين
    'top_vendors_report_generated' => 'تم إنشاء تقرير أفضل الموردين بنجاح',
    'vendors_summary_generated' => 'تم إنشاء ملخص الموردين بنجاح',
    'vendor_performance_generated' => 'تم إنشاء تقرير أداء المورد بنجاح',
    'vendors_by_category_generated' => 'تم إنشاء تقرير الموردين حسب الفئة بنجاح',
    'vendor_trends_generated' => 'تم إنشاء تقرير اتجاهات المورد بنجاح',
    'low_performing_vendors_generated' => 'تم إنشاء تقرير الموردين ضعيفي الأداء بنجاح',
    'vendors_comparison_generated' => 'تم إنشاء تقرير مقارنة الموردين بنجاح',
    'vendors_growth_generated' => 'تم إنشاء ترتيب نمو الموردين بنجاح',
    'vendors_dashboard_generated' => 'تم تحميل لوحة تحكم الموردين بنجاح',

    // Vendors Report Fields
    'invalid_sort_by_vendors' => 'حقل الترتيب غير صالح. استخدم: revenue أو orders أو products أو rating',
    'is_active' => 'نشط',
    ...
    'inactive_vendors' => 'الموردين غير النشطين',
    'average_revenue_per_vendor' => 'متوسط الإيراد لكل مورد',
    'average_orders_per_vendor' => 'متوسط الطلبات لكل مورد',
    'growth_rate' => 'نسبة النمو',
    'growth_amount' => 'مقدار النمو',
    ...
    'merchant_loyalty_settings' => 'إعدادات ولاء التجار',
    'merchant_loyalty_setting' => 'إعداد ولاء التاجر',
    'manage_active_status_and_merchant_assignment' => 'إدارة حالة النشاط وتعيين التاجر.',
    'earning_rules' => 'قواعد الاكتساب',
    'define_how_customers_earn_points_based_on_their_spend' => 'تحديد كيفية اكتساب العملاء للنقاط بناءً على إنفاقهم.',
    'spend_amount_required' => 'مبلغ الإنفاق المطلوب',
    'the_amount_a_customer_needs_to_spend_to_earn_the_reward_points' => 'المبلغ الذي يحتاج العميل لإنفاقه لاكتساب نقاط المكافأة.',
    'reward_points_earned' => 'نقاط المكافأة المكتسبة',
    'points_earned_for_every_multiple_of_the_spend_amount' => 'النقاط المكتسبة لكل مضاعف لمبلغ الإنفاق.',
    'redemption_rules' => 'قواعد الاستبدال',
    'define_how_customers_can_redeem_their_points' => 'تحديد كيفية استبدال العملاء لنقاطهم.',
    'minimum_points_to_redeem' => 'الحد الأدنى للنقاط للاستبدال',
    'the_minimum_points_balance_required_before_redemption_is_allowed' => 'الحد الأدنى لرصيد النقاط المطلوب قبل السماح بالاستبدال.',
    'redemption_points_block' => 'كتلة نقاط الاستبدال',
    'points_must_be_redeemed_in_multiples_of_this_block_size' => 'يجب استبدال النقاط بمضاعفات هذا الحجم (مثل: 100).',
    'discount_value_per_block' => 'قيمة الخصم لكل كتلة',
    'the_monetary_discount_applied_per_block_of_redeemed_points' => 'الخصم المالي المطبق لكل كتلة من النقاط المستبدلة.',
    'reward_points' => 'نقاط المكافأة',
    'redemption_block' => 'كتلة الاستبدال',
