    ...
    <aside id="sidebar" class="sidebar fixed top-0 right-0 h-full bg-white/80 dark:bg-gray-800/90 backdrop-blur-xl border-l border-orange-100 dark:border-gray-700 shadow-2xl z-40">
        <div class="flex flex-col h-full">
            ...
            <nav class="flex-1 p-4 space-y-2 overflow-y-auto">
                ...
                <a href="{{ route('docs.required-reports') }}"
                    class="nav-item flex items-center gap-3 px-4 py-3 rounded-xl text-gray-600 dark:text-gray-300 transition-all {{ request()->routeIs('docs.required-reports') ? 'active' : '' }}">
                    <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                    </svg>
                    <span class="sidebar-text font-medium">التقارير المطلوبة</span>
                </a>
            </nav>
